...
export class ListAllProductsControllerService {

  constructor(private wsTask:WsTaskService,private localSt:LocalStorageService) { }

  getAllProducts():Promise<Product[]|void>{
    return this.wsTask.doGet('/products?authKey='+this.localSt.retrieve('authKey')).then((data:any)=>{
